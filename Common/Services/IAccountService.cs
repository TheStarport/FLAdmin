...
public interface IAccountService
{
    ...
    /// </returns>
    Task<Either<ErrorResult, Account>> GetAccountById(CancellationToken token, string id);
    ...
    ///     operation failed.
    /// </returns>
    Task<Option<ErrorResult>> UpdateAccount(CancellationToken token, Account account);
    ...
    ///     operation failed.
    /// </returns>
    Task<Option<ErrorResult>> UpdateFieldOnAccount<T>(CancellationToken token, string accountId, string name, T value);
    ...
    ///     operation failed.
    /// </returns>
    Task<Either<ErrorResult, Account>> CreateWebMaster(CancellationToken token, LoginModel loginModel);
    ...
    ///     operation failed.
    /// </returns>
    Task<Either<ErrorResult, Account>> GetAccountByUserName(CancellationToken token, string userName);
    ...
    /// </returns>
    Task<Either<ErrorResult, List<Account>>> GetAccountsActiveAfterDate(DateTimeOffset date,
    ...
    ///     operation failed.
    /// </returns>
    Task<Option<ErrorResult>> AddRolesToAccount(string id, List<Role> roles, CancellationToken token);
    ...
    ///     operation failed.
    /// </returns>
    Task<Option<ErrorResult>> SetUpAdminAccount(string accountId, LoginModel login, CancellationToken token);
    ...
    ///     operation failed.
    /// </returns>
    Task<Option<ErrorResult>> ChangePassword(LoginModel login, string newPassword, CancellationToken token);
    ...
    ///     operation failed.
    /// </returns>
    Task<Option<ErrorResult>> BanAccounts(List<Tuple<string, TimeSpan?>> bans, CancellationToken token);
    ...
    ///     operation failed.
    /// </returns>
    Task<Option<ErrorResult>> UnBanAccounts(string[] ids, CancellationToken token);
    ...
    ///     operation failed.
    /// </returns>
    Task<Option<ErrorResult>> RemoveRolesFromAccount(string id, List<Role> roles, CancellationToken token);
    ...
    /// </returns>
    Task<Either<ErrorResult, bool>> IsWebMasterSetup(CancellationToken token);
}
