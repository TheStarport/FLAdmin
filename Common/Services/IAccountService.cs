...
public interface IAccountService
{
    ...
    /// <summary>
    /// Retuns a list of all accounts on the database.
    /// </summary>
    /// <returns>List of all acounts on the database, The list will be empty if an error occurs</returns>
    ...
    /// <returns>A "Left/Right" Either object, Left being an error if the operation was a failure, Right being the account if the operation was successful.</returns>
    ...
    /// <summary>
    /// Updates an Account's field, Type-safety of empty lists is not guaranteed so exercise caution when updating fields with lists.
    /// </summary>
    ...
    /// <returns>A "Left/Right" Either object, Left being an error if the operation was a failure, Right being the List of accounts if the operation was successful.</returns>
