...
public class Character
{
	...
	public List<Equipment> BaseEquipment { get; set; } = new();
	[BsonElement("cargo")]
	public List<Cargo> Cargo { get; set; } = new();
	[BsonElement("baseCargo")]
	public List<Cargo> BaseCargo { get; set; } = new();
	[BsonElement("collisionGroups")]
	public Dictionary<string, float> CollisionGroups { get; set; } = new();
	[BsonElement("visits")]
	public Dictionary<long, int> Visits { get; set; } = new();
	[BsonElement("shipTypesKilled")]
	public Dictionary<long, int> ShipTypesKilled { get; set; } = new();
	[BsonElement("systemsVisited")]
	public List<long> SystemsVisited { get; set; } = new();
	[BsonElement("basesVisited")]
	public List<long> BasesVisited { get; set; } = new();
	[BsonElement("jumpHolesVisited")]
	public List<long> JumpHolesVisited { get; set; } = new();
	[BsonElement("npcVisits")]
	public List<NpcVisit> NpcVisits { get; set; } = new();
	[BsonElement("weaponGroups")]
	public Dictionary<int, List<string>> WeaponGroups { get; set; } = new();
}
